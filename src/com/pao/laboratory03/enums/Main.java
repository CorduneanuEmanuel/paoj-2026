...
public class Main {
    public static void main(String[] args) {
        ...
        Priority emi = Priority.HIGH;
        System.out.println(emi.getLevel());

        for(var a : Priority.values()){
            System.out.println(a.getEmoji()+" "+a+" (level="+a.getLevel()+", color="+a.getEmoji()+")");
        }

        switch(emi){
            case Priority.LOW:
                System.out.println(emi.getColor());
                break;
        ...
        if(Priority.valueOf("HIGH")==Priority.HIGH){
            System.out.println("ESTE CORECT");
        }
        if(emi==Priority.HIGH){
            System.out.println("MERGE COMPARATIA");
        }
