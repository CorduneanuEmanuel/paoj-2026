...
public class Main {
    public static void main(String[] args) {
        ...
        if (hashmap.containsKey("rust")){
            System.out.println("Contine cheia");
        }
        for(var a : hashmap.entrySet()){
...
//        C
        ...
        do {
             ...
             System.out.print("Introdu clasa in care vrei ca elevul sa fie adaugat:");
             String clasa=scanner.next();
             System.out.print("Introdu numele studentului ");
             String elev = scanner.next();
             obiecte.putIfAbsent(clasa, new ArrayList<String>());
             obiecte.get(clasa).add(elev);
        }while(optiune==1);

        System.out.println(obiecte.get("PAOJ"));
        System.out.println(obiecte.get("BD"));
...
//        while(true){
//
//            System.out.println("Te rog introdu optiunea:");
//            System.out.println("T")
//            switch (optiune) {
//                case 1:
//                    System.out.print("Introducere clasa:");
//                    String arg= scanner.next();
//                    obiecte.putIfAbsent(arg, new ArrayList<String>());
//                    break;
//                case 2:
//                    System.out.print("Introducere elev in clasa:");
//                    String arg
//            }
//
//        }
