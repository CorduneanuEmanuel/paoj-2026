...
public class ZooService {
    ...
    public void listAll() {
        ...
        if (animals.isEmpty()){
            ...
            int i=0;
            for (var a : animals) {
                System.out.println(" " + (i++) + ". " + a.describe());
            }
        }
    }
    ...
    public void listByType(String type) {
        ...
        if(!found){
            System.out.println("Nu e gasit animal cu tipul dat ca parametru");
        }
    }
    ...
    public void findOldest() {
        ...
        if (animals.isEmpty()){
            ...
            System.out.println(oldest.getName() +" este cel mai batran");
        }
    }
}
